package com.android.homework.todolist.ui;
...
import com.android.homework.todolist.NoteOperator;
import com.android.homework.todolist.R;
 ...
 */
public class NoteListAdapter extends RecyclerView.Adapter<NoteViewHolder> implements Comparable<NoteViewHolder>{
    ...
    @Override
    public int compareTo(NoteViewHolder o) {
        return 0;
    }
}
